...
path_to_bag_files = ('/media/neosh/5FB92F7D501A5B3A/Clopema/20140212/p3/'); 

%% A folder for mat files - is not necessary
path_to_mat_files = ('/media/neosh/5FB92F7D501A5B3A/Clopema/20140212/p3/'); 